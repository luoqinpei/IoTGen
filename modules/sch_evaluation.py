...
from modules.utils.netlist_comparison import compare_netlists_sets
...
judge_llm = GetLLMInterface(model_name="gpt-5.1", model_provider="OpenRouter")

class SchematicVerifier():
    def __init__(self, module_name, schematic_name, model_name="o4"):
        ...
        if model_name == "o3":
            self.llm = GetLLMInterface(model_name="o3", model_provider="OpenRouter")
        else:
    ...
    def netlist_verify(self, schematic_path = None) -> str:
        ...
        standard_path = Path(project_path) / "dataset" / self.module_name / self.schematic_name
        standard_netlist = get_schematic_netlist(standard_path, "schematic_standard.net")
...
if __name__ == "__main__":
    ...
    path = "finetune_dataset_reduced.jsonl"
