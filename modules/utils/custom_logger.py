'''
Logging module for the project, providing a custom logger with colored output and file logging capabilities. The logger is designed to be easily integrated into the project, allowing for consistent and informative logging throughout the codebase. It supports different logging levels (DEBUG, INFO, WARNING, ERROR, CRITICAL) and can capture logs to a string for further processing or testing purposes. The log files are stored in a designated directory with timestamps for easy organization and retrieval.
'''
