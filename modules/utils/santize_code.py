'''
Sanitization utilities for LLM-generated code before compile().
This is a best-effort fix for common syntax issues observed in model-generated code, such as repeated keyword arguments in function calls. Extend this over time as you observe more issues.
'''
import io
import re
import sys
