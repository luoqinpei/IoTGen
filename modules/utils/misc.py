'''
This module provides miscellaneous utility functions for the project, including functions to get and set the schematic path, get the project path, get the symbol and footprint library paths, reverse Y coordinates for KiCad, and check for line duplicates. These utilities are used throughout the project to manage file paths and handle geometric calculations related to KiCad schematics and PCBs.
'''
import os
...
def get_schematic_path():
    ...
    # sch_path = project_path / "KiCAD_Project" / "test_v8" / "test_v8.kicad_sch"
