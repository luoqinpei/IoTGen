'''
Module definitions for schematic components and their associated data structures.
Used as feedback templates for LLM-based evaluation of schematic designs, as well as for defining the context information of symbols in the schematic editor. This module provides a structured way to represent various aspects of circuit modules, symbols, and feedback from design evaluations.
'''
