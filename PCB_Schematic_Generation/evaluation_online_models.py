...
model_names = ["gpt-oss-20b"]  # "o4-mini", "gpt5", "grok"
levels = ["L1"]  # "L1", "L2", "L3"
...
def run_batch_evaluation(
    ...
    llm = GetLLMInterface(model_name=model_name, model_provider="OpenRouter")
...
if __name__ == "__main__":
    ...
    for i in range(len(model_names)):
        for level in levels:
            run_batch_evaluation(jsonl_path = str(Path(project_path) / "jsonl_dataset" / f"finetune_dataset_{level}.test.jsonl"), out_dir=eval_path, model_name=model_names[i], level=level)